...
<div id="win" class="easyui-window" 
	...
	<form id="fm" style="padding:10px 20px 10px 40px;" onkeypress="keyPress(event)">
		...
		<table>
			<tr><td>用户名: </td><td><input value="admin" name="username" type="text" class="easyui-validatebox" required="true"></td></tr>
			<tr><td>密    码: </td><td><input value="admin" name="password" type="password" class="easyui-validatebox" required="true"></td></tr>
			<tr>
			<td></td>
			<td>

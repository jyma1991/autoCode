...
<div id="step2" style="display: none;width: 600px;">
	<fieldset style="border: 1px solid #ccc;font-size: 12px;">
	    <legend>输入包名</legend>
	    package: <input value="com.ryt.web" id="packageName" type="text" style="width:260px; "/> (不填则表名作为包名)
	</fieldset>
	<br>
...
<div id="step3" style="display: none;">
	...
	<br/>
		模块名:&nbsp;<input id="modelName" class="easyui-textbox" type="text"></input>
	<br>
...
function finish(){
	...
	GeneratorParam.modelName = $("#modelName").val();
